...
help_message = '''Привет. Для начала работы добавь меня в чат и выдай права администратора.
Для настройки напиши мне в личку /start — покажу чаты, где ты админ.
Новичок в чате проходит короткую анкету на кнопках (выпускник / студент / друг / сотрудник РЭШ); выпускников я узнаю автоматически по нику или почте.
Если нужно кикать непредставившихся, установи таймаут кика больше нуля (в минутах).
За настраиваемое время до кика я отправляю напоминание закончить анкету.
...
%USER_MENTION% — упоминание пользователя (кликабельное)
%NAME% — имя (карточка выпускника / введённый текст анкеты)
...
Мин. длина анкеты: {min_whois_length} символов
